...
class Config:
    ...
    # Audio settings
    SOUND_THRESHOLD = 2812     # Soglia per rilevamento suoni
    ...
    RECORD_VIDEO_ENABLED = True      # Abilita/disabilita registrazione video
    SEND_VIDEOS_TELEGRAM = True      # Abilita/disabilita invio video tramite Telegram
    MAX_VIDEOS = 5                   # Numero massimo di video da mantenere per categoria
    MAX_VIDEO_SIZE_TELEGRAM = 10000000  # Dimensione massima video per Telegram (10MB)
